...
#define MyAppName "pdfMelange"
#define MyAppVersion "0.4-beta.1"
#define MyAppPublisher "derToki"
#define MyAppURL "http://www.example.com/"
#define MyAppExeName "pdfMelange.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{0DDB7019-39AB-4A87-9E69-BBE689144723}
AppName={#MyAppName}
...
[Files]
Source: "dist\bin\pdfmelange.exe"; DestDir: "{app}\bin"; Flags: ignoreversion
